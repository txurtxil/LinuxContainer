...
complete -c cat -s T -l show-tabs -d 'display TAB characters at ^I'
complete -c cat -s v -l show-nonprinting -d 'use ^ and M- notation, except for LF (\\n) and TAB (\\t)'
complete -c cat -s u -d '(ignored)'
complete -c cat -s h -l help -d 'Print help'
complete -c cat -s V -l version -d 'Print version'

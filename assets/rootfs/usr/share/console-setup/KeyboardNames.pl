...
%variants = (
    ...
    'brai' => {
	'Braille (one-handed, left)' => 'left_hand',
	'Braille (one-handed, left, inverted thumb)' => 'left_hand_invert',
	'Braille (one-handed, right)' => 'right_hand',
	'Braille (one-handed, right, inverted thumb)' => 'right_hand_invert',
    },
    'by' => {
	...
	'Arabic (Pakistan)' => 'ara',
	'Sindhi' => 'snd',
	'Urdu (Pak Urdu Phonetic)' => 'pak_urdu_phonetic',
	...
	'Ukrainian (Windows Enhanced)' => 'winkeysenhanced',
	...
	'English (Dvorak, Macintosh, ANSI)' => 'dvorak-mac',
	'English (Dvorak, Macintosh, ISO)' => 'dvorak-mac-iso',
	'English (Dvorak, alt. intl.)' => 'dvorak-alt-intl',
	'English (Dvorak, intl., with dead keys)' => 'dvorak-intl',
	'English (Dvorak, one-handed, left)' => 'dvorak-l',
	'English (Dvorak, one-handed, right)' => 'dvorak-r',
	'English (Macintosh, ABC, ANSI)' => 'mac',
	'English (Macintosh, ABC, ISO)' => 'mac-iso',
